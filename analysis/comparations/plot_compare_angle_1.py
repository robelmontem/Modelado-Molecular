...
axes[0].plot(t298, angle1_298, linewidth=1.5)
axes[0].set_title("CA-CB-CG (ARG) at 298 K")
axes[0].set_ylabel("Angle (deg)")
axes[0].grid(True, linestyle="--", alpha=0.4)

axes[1].plot(t400, angle1_400, linewidth=1.5)
axes[1].set_title("CA-CB-CG (ARG) at 400 K")
axes[1].set_xlabel("Time (ps)")
axes[1].set_ylabel("Angle (deg)")
axes[1].grid(True, linestyle="--", alpha=0.4)

plt.tight_layout()
plt.savefig("angle_comparison_1.png", dpi=300)
plt.show()
